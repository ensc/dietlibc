...
#undef ntohl
#undef ntohs
uint32_t htonl(uint32_t hostlong) __pure;
uint16_t htons(uint16_t hostshort) __pure;
uint32_t ntohl(uint32_t netlong) __pure;
uint16_t ntohs(uint16_t netshort) __pure;
