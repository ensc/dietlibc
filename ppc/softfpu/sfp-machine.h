...
# define FP_INIT_ROUNDMODE						\
  do									\
    {									\
      ...
      _r = prctl(PR_GET_FPEXC, (unsigned long)&_ftrapex);				\
      if (_r < 0)							\
	_ftrapex = 0;							\
    }									\
  while (0)
...
#ifdef WANT_TLS
extern __thread int __sim_exceptions_thread __hidden__;
extern __thread int __sim_disabled_exceptions_thread __hidden__;
extern __thread int __sim_round_mode_thread __hidden__;
#else
extern __thread int __sim_exceptions_thread __hidden__;
extern __thread int __sim_disabled_exceptions_thread __hidden__;
extern __thread int __sim_round_mode_thread __hidden__;
...
extern void __simulate_exceptions (int x) __hidden__;
